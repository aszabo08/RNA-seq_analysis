...
The heatmap below shows all the differentially expressed genes in both datasets, comparing their change of magnitude. The log2 fold changes due to the influenza A virus show similarity.
